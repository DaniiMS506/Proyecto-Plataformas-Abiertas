...
<body>
    <header class="header">
        <h1>ING SW II - Ventas - Administrador</h1>
    </header>
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a href="../Pages/ADMIN Pages/VentasAdmin.php" class="active fa fa-usd"> Administrar Ventas</a></li>
